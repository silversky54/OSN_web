import * as d3 from 'https://cdn.jsdelivr.net/npm/d3@7/+esm';
  ...
  export async function c_snowline_ym(watershed, suffix = 'desk') {
    ...
    const svg = d3.select(`#${containerId}`)
     ...
     const text_ini = "../assets/csv/yearMonth/MCD_snowline_ym_BNA_";
     const text_end = ".csv";
...
const minValues2000To2024 = minValues.filter(d => d.year >= 2000 && d.year <= 2024 && d.value !== 0 && !isNaN(d.value));
 ...
 //console.log (minValues2000To2024)
  ...
  svg.append("line")
    ...
    .attr("x", width / 2  - 120)
    .attr("y", -25)
    .text("15. Líneas de nieve por año y mes");
...
// Etiqueta del eje Y
    svg.append("text")
        ...
        .attr("y", -40)
        .attr("x", -40)
        .text("Altura de la línea de nieve (msnm)");
...
var sen_slope_csv = "../assets/csv/sen_slope/sen_slope_sca_ym_bna.csv";
...
// Agregar el texto 
text.append("tspan")
    .text("Pendiente Theil-Sen máxima: ");
...
textMin.append("tspan")
    .text("Pendiente Theil-Sen mínima: ");
...
.on("click", function() {
    ...
    var fileName = `MCD_snowline_ym_BNA_${watershed}.csv`;
